...
<header class="main-header" >
    ...
    <a href="dashboard.php" class="logo" style="color:#AB988B; background-color: #054950;">
      ...
      <span class="logo-mini logo" style="color:#AB988B; background-color: #054950;"><b style="color:#EB8540; background-color: #054950;">A</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg logo" style="color:#AB988B; background-color: #054950;" ><b style="color:#EB8540; background-color: #054950;">Admin</b>Panel</span>
    </a>
